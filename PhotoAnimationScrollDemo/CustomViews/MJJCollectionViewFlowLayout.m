...
@implementation MJJCollectionViewFlowLayout
{
    NSInteger _index;
}
...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    for (UICollectionViewLayoutAttributes *attributes in visibleItemArray)
    {
        ...
        //5. 缩放
        attributes.transform3D = CATransform3DMakeScale(0.6 + scale * MJJMinZoomScale, 0.6 + scale * MJJMinZoomScale, 1);
